...
public class SecurityFrameworkUtils {
     ...
     * 这是 Spring Security 的核心组件。
     * 它默认使用 ThreadLocal 策略来存储安全上下文。
     * 这意味着它能获取当前请求线程（Current Thread）中的安全信息。
     *
     * 注意：如果你在子线程、异步任务（@Async）或线程池中直接调用该方法，
     * 可能会获取不到用户信息（返回 null），除非你手动配置了上下文向下传递。
     *
     * @return 认证信息
     */
