...
import cn.jonhon.jump.framework.redis.config.JumpCacheProperties;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "jump.tenant", value = "enable", matchIfMissing = true) // 允许使用 jump.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class JumpTenantAutoConfiguration {
