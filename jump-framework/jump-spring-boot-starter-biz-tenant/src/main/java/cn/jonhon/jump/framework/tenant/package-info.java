 ...
 *      1）Spring Async：
 *          {@link cn.jonhon.jump.framework.quartz.config.JumpAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 JumpSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
