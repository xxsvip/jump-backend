...
public class MyBatisUtils {
    ...
    private static final String POSTGRESQL_ESCAPE_CHARACTER = "\"";
    ...
    public static <T> Page<T> buildPage(PageParam pageParam, Collection<SortingField> sortingFields) {
        ...
        page.setOptimizeJoinOfCountSql(false); // 关联 issue：https://gitee.com/zhijiantianya/jump-cloud/issues/ID2QLL
        // 排序字段
    ...
    public static String getTableName(Table table) {
        ...
        if (tableName.startsWith(POSTGRESQL_ESCAPE_CHARACTER) && tableName.endsWith(POSTGRESQL_ESCAPE_CHARACTER)) {
