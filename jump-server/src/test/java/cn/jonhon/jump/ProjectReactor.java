...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.jonhon";
    private static final String ARTIFACT_ID = "jump";
    private static final String PACKAGE_NAME = "cn.jonhon.jump";
    private static final String TITLE = "智造运营平台";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.jonhon";
        String artifactIdNew = "jump";
        String packageNameNew = "cn.jonhon.jump";
        String titleNew = "智造运营平台";
//        String projectBaseDirNew = projectBaseDir + "-new"; // 一键改名后，“新”项目所在的目录
        String projectBaseDirNew = "E:\\program\\template\\jump-backend"; // 一键改名后，“新”项目所在的目录
